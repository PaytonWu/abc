...
public:
    ...
    xabc_bytes_with() = default;
    xabc_bytes_with(xabc_bytes_with const &) = default;
    auto operator=(xabc_bytes_with const &) -> xabc_bytes_with & = default;
    xabc_bytes_with(xabc_bytes_with &&) = default;
    auto operator=(xabc_bytes_with &&) -> xabc_bytes_with & = default;
    ~xabc_bytes_with() = default;
    ...
    constexpr void swap(xabc_bytes_with & other) noexcept {
        data_.swap(other.data_);
    }
...
private:
    friend constexpr auto operator==(xabc_bytes_with const & lhs, xabc_bytes_with const & rhs) noexcept -> bool = default;
};
