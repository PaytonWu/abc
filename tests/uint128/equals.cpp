...
TEST(External, equals){
    ...
    EXPECT_EQ(t,   abc::uint128_t(t));
    EXPECT_EQ(f,   abc::uint128_t(f));
    EXPECT_EQ(u8,  abc::uint128_t(u8));
    EXPECT_EQ(u16, abc::uint128_t(u16));
    EXPECT_EQ(u32, abc::uint128_t(u32));
    EXPECT_EQ(u64, abc::uint128_t(u64));
}
