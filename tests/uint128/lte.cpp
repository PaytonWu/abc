...
TEST(Comparison, less_than_or_equals){
    const abc::uint128_t big  (0xffffffffffffffffULL, 0xffffffffffffffffULL);
    const abc::uint128_t small(0x0000000000000000ULL, 0x0000000000000000ULL);
...
{                                                                       \
    ...
    const Z big   = std::numeric_limits <Z>::max();                     \
                                                                        \
    const abc::uint128_t int_small(small);                                   \
    const abc::uint128_t int_big(big);                                       \
                                                                        \
