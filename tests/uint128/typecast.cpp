...
TEST(Typecast, all){
    const abc::uint128_t val(0xaaaaaaaaaaaaaaaaULL, 0xaaaaaaaaaaaaaaaaULL);

    EXPECT_EQ(static_cast <bool>     (abc::uint128_t(true)),          true);
    EXPECT_EQ(static_cast <bool>     (abc::uint128_t(false)),         false);
